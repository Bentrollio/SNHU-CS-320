...
public class ContactTest {
    ...
    public void testFirstNameRequirements() {
        // Test that First Name is not longer than 10 characters
        Assertions.assertThrows(RuntimeException.class, () -> {
    ...
    public void testPhoneNumberRequirements() {
        ...
        Assertions.assertThrows(RuntimeException.class, () -> {
            contact.setPhoneNumber("18005557246");
        });
        ...
        Assertions.assertThrows(RuntimeException.class, () -> {
            contact.setPhoneNumber("800555BOOT");
        });
        // Edge Case: 9 characters
        Assertions.assertThrows(RuntimeException.class, () -> {
            contact.setPhoneNumber("800555726");
        });
